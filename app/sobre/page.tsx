...
export default function Sobre() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-black-900 dark:text-white">Jogo Cosmic</h1>
      ...
      <h2 className="text-2xl font-bold mb-4 text-black-900 dark:text-white">Objetivo Geral</h2>
      <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <h2 className="text-2xl font-bold mb-4 text-black-900 dark:text-white">Objetivos Específicos</h2>
